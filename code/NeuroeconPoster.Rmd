...
p3nl <- arrangeGrob(p1 +theme(legend.position="none"),
                         p2 + theme(legend.position="none"),
                         nrow=1)

ggsave('Lit_Review_Poster_Plot.jpg', plot = p3, device = "jpeg", path = "../output/figures/", width = 35, height = 56, units = "in", limitsize = FALSE)

ggsave('Lit_Review_Poster_Plot_nl.jpg', plot = p3nl, device = "jpeg", path = "../output/figures/", width = 24, height = 42, units = "in", limitsize = FALSE)
...
ggsave('Bootstrap_Poster_Plot.jpg', plot = p6, device = "jpeg", path = "../output/figures/", width = 24, height = 42, units = "in", limitsize = FALSE)
```
...
ggsave('DDM_raw_comp_Poster.jpg', plot = p8, device = "jpeg", path = "../output/figures/", width = 20, height = 6, units = "in")
```
...
Summarizing at task level

```{r}
p1_t <- fig_data_poster %>%
  filter(task == 'task') %>%
...
ggsave('Lit_Review_Poster_Plot_t.jpg', plot = p3_t, device = "jpeg", path = "../output/figures/", width = 26, height = 45, units = "in", limitsize = FALSE)
```
...
ggsave('Bootstrap_Poster_Plot_t.jpg', plot = p6_t, device = "jpeg", path = "../output/figures/", width = 26, height = 45, units = "in", limitsize = FALSE)
...
p10 = measure_labels %>%
  ...
  ggplot(aes(icc))+
  geom_histogram(aes(fill=param),  alpha=0.5, position = 'identity')+
  facet_grid(.~factor(raw_EZ_hddm, levels = c("raw", "EZ", "hddm", "other"), labels=c("Raw", "EZ-diffusion", "Hierarchical diffusion", "Other")))+
  theme_bw()+
  theme(legend.position="bottom",
        legend.title = element_blank(),
        legend.text= element_text(size=30),
...
ggsave('Measure_type_comp_Poster.jpg', plot = p10, device = "jpeg", path = "../output/figures/", width = 30, height = 6, units = "in")
```