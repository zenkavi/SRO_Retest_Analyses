...
render_this <- function(){rmarkdown::render('SRO_Report.Rmd', output_dir = '../output', html_notebook(toc = T, toc_float = T, code_folding = 'hide'))}
...
### Load time 1 data
```{r}
test_data <- read.csv('/Users/zeynepenkavi/Documents/PoldrackLabLocal/Self_Regulation_Ontology/Data/Complete_07-08-2017/meaningful_variables.csv')

test_data2 <- read.csv('/Users/zeynepenkavi/Documents/PoldrackLabLocal/Self_Regulation_Ontology/Data/Complete_07-08-2017/meaningful_variables_noDDM.csv')

test_data3 <- read.csv('/Users/zeynepenkavi/Documents/PoldrackLabLocal/Self_Regulation_Ontology/Data/Complete_07-08-2017/meaningful_variables_EZ.csv')
...
```{r}
test_data2 <- read.csv('/Users/zeynepenkavi/Documents/PoldrackLabLocal/Self_Regulation_Ontology/Data/Complete_07-08-2017/variables_exhaustive.csv')
...
### Load time 2 data 
```{r}
retest_data <- read.csv('/Users/zeynepenkavi/Documents/PoldrackLabLocal/Self_Regulation_Ontology/Data/Retest_09-27-2017/meaningful_variables.csv')

retest_data2 <- read.csv('/Users/zeynepenkavi/Documents/PoldrackLabLocal/Self_Regulation_Ontology/Data/Retest_09-27-2017/meaningful_variables_noDDM.csv')

retest_data3 <- read.csv('/Users/zeynepenkavi/Documents/PoldrackLabLocal/Self_Regulation_Ontology/Data/Retest_09-27-2017/meaningful_variables_EZ.csv')
...
This should not be necessary once releases are matched but for now extract only retest variables from test data.

```{r}
test_data <- test_data[,c(names(retest_data))]
```
...
rel_df = rel_df %>%
  select(dv, task, spearman, icc, eta_sq, sem, var_subs, var_ind, var_resid)
...
bootstrap_relialibility = function(metric = c('icc', 'spearman', 'eta_sq', 'sem'), dv_var, N=150){
  tmp_sample = sample_workers(N)
