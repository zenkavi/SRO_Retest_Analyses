...
- make new `rel_df` (with both types of ICC for retest paper vars)
- make new `boot_df` (with both types of ICC for retest paper vars)
- rerun MCMC models with ICC(2,1)

```{r}
rel_df = make_rel_df(test_data, retest_data, metrics = c("icc3.k", 'icc2.1', 'pearson'), vars = rt_ddm_vars)
