...
'acc', 'avg_rt', 'conceptual_responses', 'fail_to_maintain_set',
       'learning_rate', 'learning_to_learn', 'nonperseverative_errors',
       'perseverative_errors', 'perseverative_responses', 'total_errors'
...
trial_num_rel_df %>%
  ...
  ggplot(aes(breaks, value, color=key))+
  geom_point()+
  geom_line()+
  theme_bw()+
  xlab("Number of trials")+
