...
ggsave('PropTimeEffectsValence.jpg', device = "jpeg", path = "/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_Retest_Analyses/output/figures/", width = 5, height = 5, units = "in", limitsize = FALSE, dpi = 300)
```
