...
```{r}
tmp  = rel_comp %>% filter(dv == unique(rel_comp$dv)[10])
...
summary(lm(retest_reliability ~ lit_predictor, data=sampled_df))
summary(lm(retest_reliability ~ mean_icc, data=sampled_df))
```
