...
- Larger reliability estimates for surveys
- Larger variance in reliability estimates for tasks

### Sample size effects/publication bias

Deviance between our mean estimate and the reliability from the literature decreases exponentially with sample size. The smaller the sample size in the literature the more the reliability estimate differs from our results.
...
mod1 = lmer(retest_reliability~sample_size+(1|dv), data=lit_review)
