...
tmp = tmp %>%
  ...
  mutate(task_group = ifelse(task_group == "psychological refractory period two choices", "psychological refractory period", ifelse(task_group == "angling risk task always sunny", "angling risk", ifelse(task_group == "two stage task", "two step", ifelse(task_group == "threebytwo", "task switching", ifelse(task_group == "adaptive n back", "adaptive n-back", ifelse(task_group == "go nogo", "go/no-go",  ifelse(task_group == "ravens", "raven's", task_group)))))))) %>%
  mutate(task_group = gsub("survey", "", task_group),
