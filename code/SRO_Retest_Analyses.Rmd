...
Are you at noise ceiling for suveys vs. tasks?
...
Is this because of less data on surveys? Should I be using a different metric for goodness of fit?
...
Our data is better in predicting the literature for the surveys that it is in predicting tasks.
...
Sample one row of literature, fit model of sample size+task on remaining data, use that model to predict the reliability estimate plugging in the sample size and task for the sampled row in the model
...
Are you better in estimating the literature using our data for surveys vs tasks?
