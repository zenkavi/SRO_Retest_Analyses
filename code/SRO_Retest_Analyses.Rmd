...
source('/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_Retest_Analyses/code/SRO_Retest_Analyses_Workspace.R')
...
ggsave('Lit_Review_Plot_t.tiff', plot = p3_t, device = "tiff", path = "/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_Retest_Analyses/output/figures/", width = 27, height = 52, units = "in", limitsize = FALSE, dpi = 250)
```
...
Are there differences between clinical and non-clinical samples in the literature?

```{r}
tmp = lit_review %>%
  mutate(clinical = as.character(clinical),
         clinical = ifelse(clinical == "", "control", clinical),
         clinical_1_0 = ifelse(clinical == "control", 0, 1))
table(tmp$clinical)
table(tmp$clinical_1_0)
summary(lmer(retest_reliability ~ clinical_1_0+(1|dv),data=tmp))
```
...
ggsave('LitAndBoot_Noise_Ceiling.tiff', device = "tiff", path = "/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_Retest_Analyses/output/figures/", width = 7, height = 5, units = "in", limitsize = FALSE, dpi = 300)
```
...
ggsave('LitAndEmpAveCor.tiff', device = "tiff", path = "/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_Retest_Analyses/output/figures/", width = 7, height = 5, units = "in", limitsize = FALSE, dpi = 300)
```
