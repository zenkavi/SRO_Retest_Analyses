...
ggsave('LitAndEmpAveCor.jpg', device = "jpeg", path = "/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_Retest_Analyses/output/figures/", width = 4, height = 4, units = "in", limitsize = FALSE, dpi = 500)
```
