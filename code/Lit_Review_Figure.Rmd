...
render_this <- function(){rmarkdown::render('Lit_Review_Figure.Rmd', output_dir = '/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_Retest_Analyses/output/', html_notebook(toc = T, toc_float = T, code_folding = 'hide'))}
