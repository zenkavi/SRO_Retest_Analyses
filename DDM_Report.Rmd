...
**GO ON SHERLOCK AND CHECK IF YOU INDEED FIT IT TO THE RETEST SAMPLE ONLY**
...
```{r}
raw_retest_data <- read.csv('/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_Retest_Analyses/raw_retest_data.csv')
```
