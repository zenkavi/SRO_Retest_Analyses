...
for(i in 1:length(numeric_cols)){
  cor_df[numeric_cols[i], 'spearman'] <- get_spearman(numeric_cols[i]) 
}
...
*Rank orders for tasks*

```{r}

```

*Rank order for surveys:*
...
bootstrap_relialibility = function(metric = c('icc', 'spearman', 'eta_sq', 'sem'), dv_var){
  ...
  get_icc(dv_var, sample = 'bootstrap', sample_vec = tmp_sample, format='wide')
  get_spearman(dv_var, sample = 'bootstrap', sample_vec = tmp_sample, format='wide')
  get_eta(dv_var, sample = 'bootstrap', sample_vec = tmp_sample)
  get_sem(dv_var, sample = 'bootstrap', sample_vec = tmp_sample, format='wide')
}
